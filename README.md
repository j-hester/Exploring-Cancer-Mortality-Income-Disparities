...
Cancer Mortality Data
    ...
    Combined individual CSV files for each year into a single data frame.

    Selected relevant columns: County, Population at Risk, Deaths, Crude Mortality Rate, Year.

    Converted Year from character to numeric.

Income Data

    Extracted county-level per capita income.

    Pivoted data from wide to long format and then back to wide to align Year and Income columns.

    Cleaned and arranged data for analysis.
...
Cancer Mortality Trends
    ...
    Top 5 counties with the lowest average mortality:
    Displayed using flextables in the HTML output.

    Top 5 counties with the highest average mortality:
    Displayed using flextables in the HTML output.
